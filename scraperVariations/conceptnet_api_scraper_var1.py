...
# To lookup utils folder in parent directory
import sys
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))
from utils.text2uri import standardized_uri

# Return to parent directory where original scraper file was
os.chdir("..")
...
def parse_response(input_folder:str, output_folder:str) -> None:
    ...
    blacklisted_relations = {"/r/Antonym"}
    ...
    keywords_df.to_csv(f'{output_folder}/edge_extractVar1.csv', index=False)
    return
